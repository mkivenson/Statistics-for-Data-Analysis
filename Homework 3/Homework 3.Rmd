...
### Part B
These data appear to follow a normal distribution because:  
*the distribution plot is somewhat consistent with a normal curve
*The q-q plot for this distribution is close to the q-q line. 
*The values are distributed between standard deviations with similar proportions as a normal distribution.

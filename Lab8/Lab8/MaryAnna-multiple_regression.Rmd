...
3.  Excluding `score`, select two other variables and describe their relationship 
    ...
    I decided to visualized the relationship between age and average beauty rating of a teacher. It seems like age and beauty of teachers has a weak, linear, and negative relationship.
...
6.  Use residual plots to evaluate whether the conditions of least squares
    ...
    *Linearity*: The scatter plot of bty_avg and score has a weak positive linear relationship. We also look at the residuals scatter plot to check for linearity.
...
```   
    ...
    *Nearly normal residuals*: The distribution of residuals is skewed to the left, centered close to zero and is nearly normal.
    
```{r hist-res, eval=TRUE}
hist(m_bty$residuals)
```
    
    *Constant variability*: The scatter plot of residuals shows constant variability for all values of bty_avg.
